  ...
  Widget build(BuildContext context) {
    ...
    final Widget headerText = widget.isMobilePlatform
        ? Container(
            ...
            width: isCenterAlignment && headerWidth > 150 ? 150 : 150,
            height: headerHeight,
    ...
    final Widget todayIcon = widget.showTodayButton
        ? Container(
            ...
            color: headerBackgroundColor,
             //width: 200,
             height: 35,
          //padding: EdgeInsets.all(useMobilePlatformUI ? 2 : 5),
            child: Material(
                color: headerBackgroundColor,
                child: InkWell(
                  ...
                  child: Semantics(
                    ...
                    child: useMobilePlatformUI
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 10),
                            alignment: Alignment.center,
                            child: Text('Today',style: TextStyle(fontSize: style.fontSize,color: Colors.white),)
                            // Icon(
                            //   Icons.today,
                            //   color: style.color,
                            //   size: style.fontSize,
