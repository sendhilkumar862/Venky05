                              ...
                              buttonTap: () async {
                                if (_homeController.classRelatedList[index]
                                  ...
                                  if (_homeController.classRelatedList[index]
                                    ...
                                    showModalBottomSheet(
                                      ...
                                      builder: (BuildContext context) {
                                        return BookingBottomSheet(
                                          height: MediaQuery.of(context).size.height * 0.9.px,
                                        onPressed:  () async {
                                          final bool status =
                                    ...
                                    final bool status = await _homeController
                                        .bookClassDetail(
                                            _homeController
                                                .classRelatedList[index]
                                                .classNumber!,
            ...
            return Column(children: <Widget>[
                          ...
                          onTap: () async {
                            ...
                            if (_homeController
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (BuildContext context) {
                                  return BookingBottomSheet(
                                    height:MediaQuery.of(context).size.height * 0.95.px,
                                    onPressed:  () async {
                                      final bool status =
                                      await _homeController
                                          .bookClassDetail(
                              ...
                              bool status = await _homeController
                                  .bookClassDetail(
                                      _homeController
                                          .classRelatedList[index].classNumber!,
                                      {});
              ...
              Obx(
                () => AppButton(
                  onPressed: () async {
                    Get.back();
                    bool status = await _homeController.bookClassDetail(
                        _homeController.classRelatedList[index].classNumber!, {
