...
class ChangePasswordController extends GetxController{
  ...
  Future<bool> requestChangePassword() async {
    ...
    final BaseResponse changePasswordResponse = await _changePasswordRepository.passwordChange(
        oldPassword: oldPasswordController.text, newPassword: passwordController.text,retypedPassword: retypedPasswordController.text);
  ...
  void onTapTermAndCondition() {
    ...
    isPassWordCriteria[5] =
        retypedPasswordController.text == passwordController.text && passwordController.text.isNotEmpty;
  ...
  void validatePassword(String value, Function setState) {
    ...
    isPassWordCriteria[5] = value == retypedPasswordController.text && value.isNotEmpty;
    isButtonActive.value = isActive.value && isPassWordCriteria.every((bool element) => element);
    setState(() {});
  }
