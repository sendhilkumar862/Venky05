...
class _ManageSubscriptionState extends State<ManageSubscription> {
  ...
  SubscribeNowHeading(heading: 'Pro',currency: '10 KWD', subscribeNowList: [
      SubscribeNow(title: 'More trustable teacher profile and recommended by Hessah app.'),
                         ...
                         child: Container(
                           ...
                           decoration: BoxDecoration(
                             gradient: LinearGradient(
                               ...
                               colors: [AppColors.appBlue, Colors.white,Colors.white,Colors.white.withOpacity(0.1)],
                           ...
                           child: Column(children: [
                             Row(
                               ...
                               children: <Widget>[
                                 Padding(
                                   ...
                                   child: Text(
                                     data.heading,
                                     style: openSans.get36.w800.textColor(AppColors.primaryColor),
                                   ),
                                 ),
                                 Padding(
                                   padding: const EdgeInsets.only(left:5),
                                   child: StatusCardView(status: data.heading == 'Pro' ? 'PRO':'ADS',),
                                 )
                               ],
                             ),
                             ListView.builder(
                                 ...
                                 return Row(
                                   ...
                                   children: [
                                     ...
                                     Expanded(child: Padding(
                                       ...
                                       child: Text(res.title,style: openSans.get14.w400.appTextColor),
                                     ))
                                   ],
                                 );
                               },
                             ...
                             AppButton(
                                 ...
                                 title: 'Subscribe Now',
                                 onPressed: (){
                                   data.heading == 'Ads' ?   appBottomSheet(
                                       context: context, commonWidget: BookingBottomSheet()):Text('You are not eligible at this time for this plan',);
                                 }
                             )
