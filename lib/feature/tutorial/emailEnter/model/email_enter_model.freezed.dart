...
class _$EmailEnterModelImpl implements _EmailEnterModel {
  const _$EmailEnterModelImpl({required this.data, required this.status});
...
abstract class _EmailEnterModel implements EmailEnterModel {
  const factory _EmailEnterModel(
      {required final Data data,
      required final Status status}) = _$EmailEnterModelImpl;
...
class _$ItemImpl implements _Item {
  const _$ItemImpl({required this.userId, required this.status});
...
abstract class _Item implements Item {
  const factory _Item(
      {required final int userId, required final String status}) = _$ItemImpl;
