...
class GetProposalDetailRepository {
  Future<BaseResponse> getProposalDetail (String id) async {
    try {
...
class ClassProposalAPIRequest extends BaseRequest {
  ...
  @override
  String get endPoint => '${ApiEndpoint.school(SchoolEndpoint.CREATE_CLASS)}/$id${ApiEndpoint.school(SchoolEndpoint.PROPOSAL)}';
  @override
